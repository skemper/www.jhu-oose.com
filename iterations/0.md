# Iteration 0: Group Formation & Project Proposal
...
After you register your group, you’ll have access to a repository at `https://github.com/jhu-oose/{{site.course}}-group-<identifier>`.

Registering a group creates a repository at `https://github.com/jhu-oose/{{site.course}}-group-<identifier>`. This is the repository you will use for the rest of the course to submit iterations, receive grades, communicate with your project advisor, and so forth.
