...
In general, Individual Assignments start on Mondays and end in one week. We recommend that you submit by the Soft Deadline to avoid overlaps with the subsequent Assignment, but you may submit until the Hard Deadline without consequences. We don’t accept submissions after the hard deadline because by then we already started grading and publishing answers.

In general, Group Project Iterations start on Mondays and end in two weeks.

The Hard Deadlines for Individual Assignments never coincide with the end of Group Project Iterations.
